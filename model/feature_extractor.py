...
class FeatureExtractor(object):
    def __init__(self, len_sequences=10):
        ...
        self.scalar_fields = ['instant_t', 'windspeed', 'latitude', 'longitude',
                              'Jday_predictor', 'max_wind_change_12h', 'dist2land']
        ...
        for id in ids:
            ...
            for i in range(self.max_len):
                seq_line[:, self.max_len - 1 -
                         i] = np.array(([padding_value] * i + list(ligne))[0:len(ligne)])
    ...
    def cross_features(self, X_df):
        ...
        X_df["diff_current_max"] = X_df["windspeed"] - X_df["max_wind_change_12h"]
